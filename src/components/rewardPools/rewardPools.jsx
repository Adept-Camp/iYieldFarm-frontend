...
class RewardPools extends Component {
      ...
      <div className={ classes.root }>
        ...
        <div className={ classes.intro }>
          <Card className={ classes.addressContainer } onClick={this.overlayClicked}>
            ...
            <div style={{ background: '#00f539', opacity: '1', borderRadius: '10px', width: '10px', height: '10px', marginRight: '3px', marginTop:'3px', marginLeft:'6px' }}></div>
          </Card>
        </div>
  ...
  renderRewardPool = (rewardPool) => {
    ...
    return (<div className={ classes.rewardPoolContainer} key={ rewardPool.id } >
     <Typography variant='h3' className={ classes.poolName }><img src="https://yfv.finance/static/media/DAI-logo.662e0cc6.png" width="16" height="16" /> { 'DAI Balancer Pool' }</Typography>
      ...
      <Typography varian='h4' className={ classes.tokensList } align='center'>
        { rewardPool.tokens.length > 0 && 'DAI/IYF(98/2) - This pool has closed, it is no longer rewarding IYF. Stay tuned for future updates to Staking.'  }
