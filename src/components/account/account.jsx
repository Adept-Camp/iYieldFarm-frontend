    ...
    return (
      <div className={ classes.notConnectedRoot }>
        ...
        <div className={ classes.connectHeading }>
          <img src='https://iyf.finance/apple-icon-180x180.png' />
		  <Typography variant='h3'>Welcome to iYieldFarm - Link your wallet to farm and use our decentralized Arbitrage tools</Typography>
        </div>
