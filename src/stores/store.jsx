...
class Store {
  constructor() {
   ...
   //       YieldCalculatorLink: "https://yieldfarming.IYF.finance/IYF/ycrv/",   //收益率器地址
 ...
 //         tokens: [
  ...
  //        ]
     //   },
        //{
          id: 'DAI Balancer POOL',
          name: 'Balancer Pool',
          website: 'pools.balancer.exchange',
          link: 'https://pools.balancer.exchange/#/pool/0x21a4021f4794715827fb534161305ea532becf83',
          YieldCalculatorLink: "https://yieldfarming.IYF.finance/IYF/IYF_dai/", //收益率器地址
          depositsEnabled: true,
          tokens: [
            {
              id: 'bpt',
              address: '0x21a4021f4794715827fb534161305ea532becf83',
              symbol: 'BPT',
              abi: config.erc20ABI,
              decimals: 18,
