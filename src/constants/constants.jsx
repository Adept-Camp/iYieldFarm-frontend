...
export const REGISTER_ARBITRAGE = 'REGISTER_ARBITRAGE'
export const REGISTER_ARBITRAGE_RETURNED = 'REGISTER_ARBITRAGE_RETURNED'

export const GET_ARBITRAGE_STATUS = 'GET_ARBITRAGE_STATUS'
export const GET_ARBITRAGE_STATUS_RETURNED = 'GET_ARBITRAGE_STATUS_RETURNED'

export const REGISTER_FLASHLOANS = 'REGISTER_FLASHLOANS'
export const REGISTER_FLASHLOANS_RETURNED = 'REGISTER_FLASHLOANS_RETURNED'

export const GET_FLASHLOANS_STATUS = 'GET_FLASHLOANS_STATUS'
export const GET_FLASHLOANS_STATUS_RETURNED = 'GET_FLASHLOANS_STATUS_RETURNED'
